//Koderna i detta avsnitt tillhör inte mig. Det är alla de koder som Hans förklarade på lektionen. 
//Men jag var tvungen att göra ändringar och anpassa dem till mitt eget projekt.
//det fanns delar där jag fick fel och ChatGpt hjälpte mig där.
function initTagSelector(config) {
    ...
    function addTag(item) {
        ...
        if (!id) {
            console.warn("Invalid ID, skipping:", item);
            return;
        }
